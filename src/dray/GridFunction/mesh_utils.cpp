...
namespace detail
{
  ...
  Array<Vec<int32,4>> extract_faces(Mesh<ElemT> &mesh)
  {
...
namespace detail
{
  ...
  //
  template
  Array<Vec<int32,4>> extract_faces(Mesh<MeshElem<3u, ElemType::Quad, Order::General>> &mesh);
  ...
  //
  template
  BVH construct_bvh(Mesh<MeshElem<2u, ElemType::Quad, Order::General>> &mesh, Array<AABB<2>> &ref_aabbs);
  template
  BVH construct_bvh(Mesh<MeshElem<3u, ElemType::Quad, Order::General>> &mesh, Array<AABB<3>> &ref_aabbs);
