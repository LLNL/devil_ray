...
void Shader::composite_bg (dray::Array<dray::Vec<float, 4>> &color_buffer,
...
void Shader::set_color_table (const ColorTable &color_table)
{
  // color_table.sample(m_color_samples, m_color_map);
  m_color_table = color_table;
} // set_color table

void Shader::blend (Framebuffer &fb,
                    ColorMap &color_map,
