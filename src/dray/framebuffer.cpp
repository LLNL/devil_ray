...
void
Framebuffer::save(const std::string name)
{
  PNGEncoder png_encoder;

  png_encoder.encode((float *) m_colors.get_host_ptr(),
                      m_width,
                      m_height );
...
void
Framebuffer::save_depth(const std::string name)
{
  ...
  png_encoder.encode(dbuffer.get_host_ptr(),
                      m_width,
                      m_height );
